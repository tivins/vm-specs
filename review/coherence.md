...
- [ ] Can enums have custom methods and properties beyond the built-in `from()`, `tryFrom()`, and `value`? The spec doesn't say. Many languages allow enum methods; NL's position is unstated.
